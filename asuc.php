<div id="card" class="animated fadeIn">
    <div id="upper-side">
        ...
        <link rel="stylesheet" type="text/css" href="suc01.css">
        <svg
            version="1.1"
            id="checkmark"
        ...
        <h3 id="status">Success Registered</h3>
    </div>
    <div id="lower-side">
        <p id="message">
            Congratulations 😊 , your Data Can be Stored Succesfully.
        </p>
        <a href="dashboard01.html" id="contBtn">Continue</a>
    </div>
</div>